\begin{frame}
  ...
  \node[box] (ms) {LPBF localized driver \\ i.e. part-scale governed by melt-pool scale};

  \node[box, below=5mm of ms] (dd) {Domain decomposition\\(core mathematical tool)};
