...
\begin{document}
  ...
  \begin{frame}
    ...
    \begin{figure}
      ...
      \caption{Non-overlapping substepping decomposition. The HAZ is included in the fast partition $\Omega_f$.
        The remainder of the domain belongs to the slow partition $\Omega_s$.}
