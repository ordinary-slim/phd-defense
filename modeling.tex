...
\begin{frame}
  ...
  \begin{figure}
    ...
    \begin{tikzpicture}
      ...
      \node[inner sep=0] (img) {\def\svgwidth{0.4\textwidth}%
  ...
  \begin{figure}
    ...
    \begin{subfigure}[t]{0.32\textwidth}
      ...
      \begin{tikzpicture}[
        ...
        \coordinate (spypoint) at ($(img.south west)!.88!(img.south east)!0.35!(img.north east)$);
        \coordinate (magnifypoint) at ($(img.south west)!.7!(img.south east)!0.8!(img.north east)$);

        \spy [black, width=2cm, height=2cm, magnification=3] on (spypoint) in node[fill=white] at (magnifypoint);
