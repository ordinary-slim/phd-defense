    ...
    \begin{figure}
      ...
      \begin{subfigure}[t]{0.33\textwidth}
        ...
        \begin{axis}[
            ...
            domain=-0.1:1.1,
            ylabel=$f_l'$,
            legend style={at={(0.8,0.6)},anchor=west},
            height=0.4\pageheight
            ]
      ...
      %   \end{tikzpicture}
      % \end{subfigure}
      \caption{Hyperbolic tangent $f_l$ and derivative \citep{kollmannsberger2018}.}
...
\begin{frame}
  ...
  \end{figure}
  \vspace{-11mm}
  Phase change approach of \cite{kollmannsberger2018}.
  Bulk and powder properties are thermally dependent
  and identical above melting point.
\end{frame}
