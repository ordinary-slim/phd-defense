...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Comparison with Dirichlet substepper of \cite{hodge2021}.\\
      Will be referred to as \textit{Dirichlet} substepper.
    \item Realistic speedup estimates.
    \item Tweaks and limitations of substepping.
    \item Combination with advected subdomain.
  \end{itemize}
\end{frame}
