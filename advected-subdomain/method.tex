...
%           \caption{$\mathcal{T}^m \leftarrow \texttt{shapeSubdomain}(\mathcal{T}^m_{bg})$ at $t^n$}
%         \end{subfigure}%
%         \hfill%
%         \begin{subfigure}[t]{0.49\columnwidth}
%           \includegraphics[height=0.34\pageheight]{2d_meshing_example/after_intersec1.png}
%           \caption{$\mathcal{T}^m \leftarrow \texttt{intersect}\big(\mathcal{T}^m, \mathcal{T}^f\big) \textrm{ at } t^n$}
%         \end{subfigure}\\
%         \begin{subfigure}[t]{0.49\columnwidth}
...
%           \caption{$\mathcal{T}^f \leftarrow \texttt{subtract}\big(\mathcal{T}^f, \mathcal{T}^m\big) \textrm{ at } t^{n+1}$}
%         \end{subfigure}
